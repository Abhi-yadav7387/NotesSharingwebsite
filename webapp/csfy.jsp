...
<div class="container">
    ...
    <div class="row justify-content-center" style="margin-left:170px">
        <h1>Bsc(C.S)-First Year Subjects</h1>
    </div>
        ...
        <div class="row justify-content-center" style="margin-left:170px">
            <div class="col-sm-6 fysem">
                ...
                <a href="#Basicsofcomputersystem" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Basics of
                    Computer
                    System</a><br><br>
                <a href="#Communicationandsoftskills1" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Communication and Soft Skills – I </a><br><br>
                ...
                <a href="#Statisticaltechniquesincomputerscience" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Statistical Techniques in Computer
                    Science </a><br><br>
            ...
            <div class="col-sm-6 fysem" align="right">
                ...
                <a href="#Programminginc" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Programming in C </a><br><br>
                <a href="#Webtechnology" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Web Technology </a><br><br>
                <a href="#Communicationandsoftskills2" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal"> Communication and Soft Skills –
                    II </a><br><br>
...
<div id="Communicationandsoftskills1" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Communication and soft skills -1</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                {% for f in files %}
...
<div id="Statisticaltechniquesincomputerscience" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Statistical techniques in computer science</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                {% for f in files %}
...
<div id="Webtechnology" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Web technology</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                {% for f in files %}
...
<div id="Communicationandsoftskills2" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Communication and soft skills 2</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                {% for f in files %}
