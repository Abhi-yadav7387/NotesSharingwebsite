    ...
    <div class="container-fluid" style="border-bottom:3px solid green">
        <div class="row justify-content-center" style="margin-left:170px">
            <div class="col-sm-6 fysem">
                <h3>5st Semester</h3><br>
                <a href="#Basicsofcomputersystem" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Cloud computing</a><br><br>
                <a href="#Communicationandsoftskills1" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Rdbms</a><br><br>
                <a href="#Fundamentalofdigitallogic" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Data science</a><br><br>
                <a href="#Statisticaltechniquesincomputerscience" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Python
                    Science </a><br><br>
            ...
            <div class="col-sm-6 fysem" align="right">
                <h3>6nd Semester</h3><br>
                <a href="#Databasemanagementsystem" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">mobile app devlopement</a><br><br>
                <a href="#Programminginc" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">software tasting </a><br><br>
                <a href="#Webtechnology" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Software EngineeringProject Development Activity and Seminar</a><br><br>
                <a href="#Communicationandsoftskills2" role="button" class="btn btn-lg btn-outline-dark" data-toggle="modal">Cyber Security
                    II </a><br><br>
