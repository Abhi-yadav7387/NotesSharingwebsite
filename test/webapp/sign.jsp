    ...
    <div class="row">
        <div class="col-sm-4 ">
            ...
            <p> If you already have an account on this website,<br> Click here to Login.<br>
                <a href="Login.jsp" class="btn btn-danger text-white mt-5 mb-5" style="padding:10px">LOGIN NOW!!</a></p>
        </div>
        ...
        <div class="col-sm-8 ">
            ...
            <form method="post" action="Trying">
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <select class="form-control " name="classname" id="classofstud" required>
                    ...
                    <div class="col">
                        ...
                        <select class="form-control " name="year" id="classofstud" required>
                ...
                <input type="password" class="form-control"
                       placeholder="Password length should be maximum 10 characters" name="password"
                       id="password" required>-->
                       <label style="font-size:19px;font-family:Times New Roman">Password:</label> 
                       <input type="password" class="form-control" placeholder="Password length should be maximum 10 characters" name="password" 
                              id="password" required> <br> 
                       <div class="text-center">
   
           <input type="submit" class="btn btn-danger mt-0"
                     style="padding: 5px 30px;margin-bottom:5px; font-weight:bold;font-size:20px"
                  value="SIGN UP!!">
                </div>
            </form>
        </div>
